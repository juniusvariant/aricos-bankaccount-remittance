...
address.state </br><small><span style="color:grey">*optional* </span></small>| `string` Customer’s state. Download [here](https://s.id/-TrJR)
...
identification.identification_type </br><small><span style="color:grey">*required* </span></small>| `string` Type of identity of the customer. See [Identification Codes](#identification-codes)</br></br> Only allowed value  `KTP`,`NPWP`,`SIM`,`PASSPORT`,`KITAS`,`KITAP`</br> `Characters` <span style="color:grey"><small>10 characters</small></span>
